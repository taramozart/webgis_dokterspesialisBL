...
<body class="bg-[#FAF1E4]">
    <x-navbar />
    <div class="wrap m-auto min-h-screen container pt-[200px] flex flex-col gap-5 text-black items-center">
        <div class="wrap w-[60%] bg-white p-4 rounded-lg border border-[#84A584]">
