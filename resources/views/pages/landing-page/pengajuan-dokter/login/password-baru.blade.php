            ...
            <div class="h-screen flex flex-col items-center justify-center">
                <div
                    ...
                    <div class="text-black">
                        <div class="mb-[20px]">
                            <input type="password" name="password" id="password1" placeholder="Masukkan password baru"
