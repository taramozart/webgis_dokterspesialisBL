            ...
            <div class="w-[40%]">
                <form action="{{ route('data-baru-dokter-post') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="w-full mb-1">
                        ...
                        <select id="name" name="bidang_spesialisasi"
                            ...
                            required>
                            <option disabled selected value="">Pilih Bidang Spesialisasi</option>
                    ...
                    <div class="w-full mb-1">
                        ...
                        <input type="text" id="name" name="jadwal"
                            class="border border-[#84A584] text-gray-900 text-sm rounded-md focus:ring-[#84A584] focus:border-[#84A584] px-2 w-full bg-transparent"
                    ...
                    <div class="flex justify-between gap-2 mb-1">
                        <div class="w-full">
                            ...
                            <input type="text" id="name" name="latitude"
                                class="border border-[#84A584] text-gray-900 text-sm rounded-md focus:ring-[#84A584] focus:border-[#84A584] px-2 w-full bg-transparent"
                        ...
                        <div class="w-full">
                            ...
                            <input type="text" id="name" name="longitude"
                                class="border border-[#84A584] text-gray-900 text-sm rounded-md focus:ring-[#84A584] focus:border-[#84A584] px-2 w-full bg-transparent"
