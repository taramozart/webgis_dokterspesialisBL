        ...
        <div class="rounded h-full pb-1 mt-5">
            <div class="max-h-[calc(100%-1rem)] overflow-y-auto overflow-x-auto hide-scrollbar p-10">
                ...
                <div class="flex justify-end mb-10">
                    <div class="text-center items-center justify-center text-black font-bold text-[34px] font-bold">
                        Selamat
                        Datang, Admin
                    </div>
                </div>
                                ...
                                <tr
                                    ...
                                    <td class="px-3 py-2">
                                        <div
                                            ...
                                            <a href="{{ route('lihat-artikel', ['id' => $item['id']]) }}"
                                                title="Lihat">
                                                <div class="flex justify-center items-center m-auto text-center">Lihat
                                                </div>
                                            </a>
                                            <a href="{{ route('edit-artikel', ['id' => $item['id']]) }}" title="Edit">
                                                ...
                                                <div class="relative p-4 w-full max-w-md max-h-full">
                                                    <div class="relative bg-[#84A584] rounded-lg shadow">
                                                        ...
                                                        <div class="p-4 md:p-5 text-center">
                                                            ...
                                                            <a href="{{ route('delete-artikel', ['id' => $item['id']]) }}"
